    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=civil&populate[Innovations][populate]=file`
        );
          ...
          if (department.Innovations && department.Innovations.length > 0) {
            ...
            const mappedInnovations = department.Innovations.map((innovation, index) => {
              ...
              return {
                ...
                description: `This document contains detailed information about innovative teaching and learning methods implemented by the faculty of Civil Engineering Department.`,
        ...
        <div className="mb-6 sm:mb-8 md:mb-12">
          <div className="bg-yellow-50 rounded-lg p-4 sm:p-6 shadow-sm">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-4">
              The Department of Civil Engineering at Sree Buddha College of Engineering is committed to 
            ...
            <p className="text-sm sm:text-base text-gray-700">
              ...
              learning approaches, and assessment tools that prepare students for real-world engineering 
              challenges.
            </p>
          </div>
        </div>
