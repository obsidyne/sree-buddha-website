...
export default function AIMLDepartmentAchievements() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=AI_ML&populate[Achivements][populate]=Images`
            );
