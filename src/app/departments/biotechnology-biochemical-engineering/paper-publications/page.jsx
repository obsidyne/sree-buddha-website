...
// Main component
export default function BioTechDepartmentPaperPublications() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=BioTech&populate[Publication]=*`
        );
