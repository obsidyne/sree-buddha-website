...
export default function BiotDepartmentAchievements() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=BioTech&populate[Achivements][populate]=Images`
            );
