...
export default function EEEDepartmentFaculty() {
        ...
        const fetchFaculty = async () => {
            try {
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=EEE&populate[Faculty][populate]=Faculty_image`
                );
