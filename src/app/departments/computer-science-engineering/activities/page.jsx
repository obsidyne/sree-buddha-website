...
export default function CseDepartmentActivities() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=CSE&fields=Dept_name&populate=Activities.Images`
        );
        ...
        <div className="mb-6 sm:mb-8 md:mb-12">
          <div className="bg-yellow-50 rounded-lg p-4 sm:p-6 shadow-sm">
            ...
            <p className="text-sm sm:text-base text-gray-700">
              The Department of Computer Science & Engineering at Sree Buddha College of Engineering conducts
