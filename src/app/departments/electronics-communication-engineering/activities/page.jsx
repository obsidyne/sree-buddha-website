...
export default function EceDepartmentActivities() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=ECE&fields=Dept_name&populate=Activities.Images`
        );
