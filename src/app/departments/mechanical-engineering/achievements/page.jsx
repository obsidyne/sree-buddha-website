...
export default function MechDepartmentAchievements() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await fetch(
                `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=me&populate[Achivements][populate]=Images`
            );
