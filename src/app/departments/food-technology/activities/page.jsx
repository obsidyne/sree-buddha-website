...
export default function FTDepartmentActivities() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_STRAPI}/api/cse-depts?filters[Dept_name][$eq]=FT&fields=Dept_name&populate=Activities.Images`
        );
